#!/bin/bash
# Installs personal slash commands into ~/.claude/commands/.
...
install_slash_commands() {
    ...
    # ── /commit-code ──────────────────────────────────────────────────────────
    cat > "$commands_dir/commit-code.md" <<'COMMIT_EOF'
---
...
COMMIT_EOF
    ...
    print_status "success" "Installed /commit-code → $commands_dir/commit-code.md"
}
